...
def get_ids_grid():
    ...
    #global tg
    tg = tau.widget.taugrid.TauGrid()
    tg.setRowLabels('VcGauges:VGCT|Pressure|Vacuum, VarianDUAL:IPCT, EPS:EPS|PNV|Error')
    ...
    tg.setModel('SR/ID/SCW01/(Pressure|Vacuum|Cooler*Error)',append=True)
    #tg.showAttributeLabels(False)
    #tg.showAttributeUnits(False)
    return tg

def get_profiler(sector):
    from widgets import Qt,setup_profile_plot
    import taurus
    frame = Qt.QFrame()
...
def _get_default_tree():
    ...
    import cabling,tau,fandango
    
    tree = cabling.get_tango_nodes(CABLING_TREE)
    tree['BO/VC/ALL'] = {'BO/VC/Alarms':{},'BO01/VC/ALL':{},'BO02/VC/ALL':{},'BO03/VC/ALL':{},'BO04/VC/ALL':{},
        'BO01/VC/PNV-01':{},'BO01/VC/PNV-02':{},'BO02/VC/PNV-01':{},'BO02/VC/PNV-02':{},'BO03/VC/PNV-01':{},'BO04/VC/PNV-01':{},'BO04/VC/PNV-02':{},'BO04/VC/PNV-03':{},'BO04/VC/PIR-05':{}}
...
TOOLBAR = [
        ...
        ('Image Profile',
            ...
            lambda:launch('python %s'%wdir('image_profile.py'),[IMAGE_PROFILE])
            ),
        ('','',None),
