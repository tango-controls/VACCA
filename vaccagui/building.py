...
WDIR = DEFAULT_PATH
DEVICE = 'building/ct/sqlserver'#sys/tg_test/1'
DOMAIN = 'BUILDING' #ID03'
...
import fandango
GAUGES = fandango.get_matching_attributes('building/ct/sqlserver/*dw*et*')#'ID03/V-PEN/*/Pressure')
EXTRA_DEVICES = [d for l in (fandango.TGet('building/*/*'),fandango.TGet('*/rf/*plc*')) for d in l]

EXTRA_PANELS = []
EXTRA_PANELS.append(('PANIC','panic.gui.AlarmGUI','building'))
